                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex space-x-3 pt-2">
                            ...
                            <a href="#" className="text-gray-400 hover:text-red-500 transition-colors" aria-label="WhatsApp">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-2">
                                <a href="tel:+919876543210" className="flex items-center group">
                                    ...
                                    <span className="text-gray-400 hover:text-red-400 transition-colors text-sm">+91 98765 43210</span>
                                </a>
                                <a href="mailto:contact@vastushobha.com" className="flex items-center group">
                                    <Mail className="w-4 h-4 text-red-500 mr-3" />
                                    <span className="text-gray-400 hover:text-red-400 transition-colors text-sm">contact@vastushobha.com</span>
                                </a>
                            </div>
                        </div>
                    </div>
