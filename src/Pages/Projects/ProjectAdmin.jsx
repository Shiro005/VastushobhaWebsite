...
const ProjectsAdmin = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        subcategory: 'New', // Added subcategory field
        address: '',
        shortDescription: '',
        timeline: '',
        totalArea: '',
    ...
    const handleEdit = (project) => {
        setFormData({
            ...
            subcategory: project.subcategory || 'New', // Added
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        required
                                    >
                                        <option value="Residential">Residential Bungalows</option>
                                        <option value="ResidentialLuxurious">Luxurious Bungalows</option>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="Renewed">Renewed Project</option>
                                    </select>
                                </div>
                                            ...
                                            <tr key={project.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex flex-col gap-1">
                                                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${project.category === 'Residential'
